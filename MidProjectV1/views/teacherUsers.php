...
<!--Show Teachers--------------------------------------------------------------->
					...
					<tr>
						...
						<td align="center">
							<a href="teacherUserEdit.php?ut=teacher&un=<?=$userTeacherArray[1]?>">Edit</a>
						</td>
						<td align="center">
							<a href="../controller/teacherUserDelete.php?ut=teacher&un=<?=$userTeacherArray[1]?>">Delete</a>
						</td>
					</tr>
					<?php
							}
...
<!--Show Students--------------------------------------------------------------->
					...
					<tr>
						...
						<td align="center">
							<a href="teacherUserEdit.php?ut=student&un=<?=$userStudentArray[1]?>">Edit</a>
						</td>
						<td align="center">
							<a href="../controller/teacherUserDelete.php?ut=student&un=<?=$userStudentArray[1]?>">Delete</a>
						</td>
					</tr>
					<?php
							}
...
<!--Show Parents--------------------------------------------------------------->
					...
					<tr>
						...
						<td align="center">
							<a href="teacherUserEdit.php?ut=parent&un=<?=$userParentArray[1]?>">Edit</a>
						</td>
						<td align="center">
							<a href="../controller/teacherUserDelete.php?ut=parent&un=<?=$userParentArray[1]?>">Delete</a>
						</td>
					</tr>
					<?php
							} 
