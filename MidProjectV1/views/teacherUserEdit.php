		...
		<tr>
			<td align="center" width="20%" valign="top">
				...
				<table border="1"  width="100%" >
					...
					<tr>
						<td align="center" height="50px">
							<a href="teacherNotice.php">Notice</a>
						</td>
					</tr>
					<tr>
						<td align="center" height="50px">
							<a href="teacherAddNotice.php">Add Notice</a>
						</td>
					</tr>
					<tr>
						<td align="center" height="50px">
							<a href="teacherUsers.php">Users</a>
						</td>
					</tr>
					<tr>
						<td align="center" height="50px">
							<a href="teacherAddUser.php">Add User</a>
						</td>
					</tr>
				</table>
			</td>
			<td width="10%"></td>
			<td width="40%">
				<form method="POST" action="../controller/teacherUserEditCheck.php?ut=<?=$ut?>&un=<?=$un?>">
					<fieldset>
